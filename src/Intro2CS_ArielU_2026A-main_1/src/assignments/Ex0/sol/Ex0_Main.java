 ...
 * Note: this is not a JUnit test class - in the the next assignments such a class will be replaced with a proper JUnit (Testing) class.
 * Enter a natural even number in range of [2,100] : 98
 * a) First prime pair of range = 98 : [3, 101]
 * b) Prime pair above 1099511627776 with range of 98  : [1099511628329, 1099511628427]
 * c) The Prime closest pair of range 98 : [604073, 604171]
 * d) The 32'th closest prime pair of range 98 : [11887793, 11887891]
 * e) The program runtime is: 0.069 seconds
 *
 */
